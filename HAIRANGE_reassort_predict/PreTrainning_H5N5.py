...
if __name__ == '__main__':
    for cdss in cds:
        freq_path_in = '../Res/npy/H5N5/array_codon_freq_' + res_name + cdss+'.npy'
        freq_path_out = '../Res/npy_trm/H5N5/array_codon_freq_' + res_name +  cdss+'_trm.npy'
        print(freq_path_in)
