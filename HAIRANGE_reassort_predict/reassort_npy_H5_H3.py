...
H5_pb2_lst = np.load('../Res/npy/H5N5/array_codon_freq_ha_H5_all_pb2.npy',allow_pickle=True)
H5_pb1_lst = np.load('../Res/npy_trm/H5N5/array_codon_freq_ha_H5_all_pb1_trm.npy',allow_pickle=True)
H5_pa_lst = np.load('../Res/npy/H5N5/array_codon_freq_ha_H5_all_pa.npy',allow_pickle=True)
H5_np_lst = np.load('../Res/npy_trm/H5N5/array_codon_freq_ha_H5_all_np_trm.npy',allow_pickle=True)
inputs = []
df00 = pd.read_csv('../Data/non_h5n1_cleaned.csv')
id_reassort_lst = []
...
inputs = inputs.reshape(4*len(df00),2816,64)
print(inputs.shape)
np.save('../Res/npy_reassort/array_codon_freq_H5_all_H3_PB2_PB1_PA_NP_replaced_H5.npy', inputs, allow_pickle=True)

id_reassort_lst = np.array(id_reassort_lst)
print(len(id_reassort_lst))
np.save('../Res/npy_reassort/array_id_reassort_H5_all_H3_PB2_PB1_PA_NP_replaced_H5.npy', id_reassort_lst, allow_pickle=True)
