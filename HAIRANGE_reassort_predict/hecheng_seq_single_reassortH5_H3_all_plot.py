...
# -------------------------- 1. 配置参数与绘图风格 --------------------------
input_csv_path = "./H5_reassort/test_500+0.03_10_resnet34_reassort_H5_all_H3N2ref_0.05_0701_2816_fc.csv"
output_counts_csv = "gene_combination_risk_counts_H5_H3.csv"
...
# 保存高清图片
plt.savefig("risk_grouped_gene_combination_barplot_H5_H3.pdf", dpi=600, bbox_inches="tight", facecolor="white")
plt.show()
