...
res_name = 'ha_H5N5_all_pb2'
cds_num0 = 'CDS1'

df00 = pd.read_csv('../DataCleaning/Res/res1/H5N5_seq_all_with_8segs_without_unk_aa_remove_same_strain_name_NCBI_GISAID_and_human.csv')
df00 = df00[df00['nt2']==2274]
df00.to_csv('../DataCleaning/Res/res1/H5N5_seq_all_with_8segs_without_unk_aa_remove_same_strain_name_NCBI_GISAID_and_human_PB1_len_controled.csv',index=False)
